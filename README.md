...
# &#x20; - \[Qualitative Analysis (Visual Proofs)](#qualitative-analysis-visual-proofs)
...
# \*\*Goal:\*\* Reverse these degradations and reconstruct an image as close as possible to the original — without hallucinating detail or destroying real structure — while generalizing to unseen (out-of-distribution) test content and running efficiently on GPU hardware.
...
# &#x20; <img src="Assets/Pipeline.png" alt="ChipCrafters End-to-End Restoration Pipeline" width="90%">

# &#x20; <br>

# &#x20; <em>Figure 1: End-to-End Semiconductor Restoration and Super-Resolution Pipeline.</em>
...
# &#x20; <img src="Assets/architecture.png" alt="NAFNet-SR Architecture" width="90%">

# &#x20; <br>

# &#x20; <em>Figure 2: Detailed Architectural Layout of NAFNet-SR and the internal NAFBlock mechanism.</em>
...
# The model clearly outperforms the bicubic-upsampling baseline on structural similarity, confirming the multi-loss strategy recovers real structural detail rather than just averaging pixels.
...
# \### Qualitative Analysis (Visual Proofs)

# 

# \#### 1. Top Successful Cases (Best Restoration)

# Demonstrates sharp structural boundary reconstruction and peak PSNR scores exceeding 33 dB on complex wafer geometries:

# 

# <p align="center">

# &#x20; <img src="Assets/best\_restorations.png" alt="Top Successful Restorations" width="95%">

# &#x20; <br>

# &#x20; <em>Figure 3: Top-performing restorations on held-out validation samples (PSNR: 33.89 dB and 32.39 dB).</em>

# </p>

# 

# \#### 2. Failure Case Analysis (Challenging Degradations)

# Identifies residual noise artifacts under heavy multiplicative speckle and severe loss of high-frequency contrast:

# 

# <p align="center">

# &#x20; <img src="Assets/worst\_failures.png" alt="Failure Case Analysis" width="95%">

# &#x20; <br>

# &#x20; <em>Figure 4: Analysis of hardest degradation cases where extreme speckle noise limits boundary recovery.</em>
