...
├── scripts/
│   ├── run_inference.py       # Standalone evaluation script (CLI: --test-dir --output-dir)
│   └── benchmark_inference.py # End-to-end H100 inference-time benchmark
├── notebooks/
...
```bash
python scripts/run_inference.py --test-dir <path/to/test> --output-dir <path/to/output>
```
